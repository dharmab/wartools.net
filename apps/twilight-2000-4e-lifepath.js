...
const CAREERS = [
  ...
  },
  {
    ...
    specialtyTable: ["Paratrooper", "Ranger", "Infiltrator", "Combat Awareness", "Sniper", "SERE"],
    gear: [
  ...
  // POLICE
  {
    ...
    specialtyTable: ["Sidearms", "Melee", "Runner", "Racer", "Biker", "Scout"],
  ...
  // CRIME
  {
    ...
    specialtyTable: ["Brawler", "Melee", "Killer", "Martial Artist", "Rifleman", "Sidearms"],
  ...
  },
  {
    ...
    specialtyTable: ["Sidearms", "Infiltrator", "Scout", "Interrogator", "Psy Ops", "Trader"],
  ...
  },
  {
    ...
    specialtyTable: ["Brawler", "Melee", "Killer", "Ranger", "SERE", "Scrounger"],
    gear: ["Shiv"],
  },
  // INTELLIGENCE
  {
  ...
  // BLUE COLLAR
  {
    ...
    specialtyTable: ["Biker", "Boatman", "Navigator", "Pilot", "Racer", "Tanker"],
  ...
  },
  {
    ...
    specialtyTable: ["Cook", "Farmer", "Fisher", "Hunter", "Forager", "Rider"],
  ...
  // EDUCATION
  {
    ...
    specialtyTable: ["Historian", "Cook", "Linguist", "Musician", "Psy Ops", "Counselor"],
